export function headerSticky(container = document) {
  ...
  const headerTopPart = document.querySelector('header.akwan_website_header .menu-top-menu-container').clientHeight;
  const headerHeight = document.querySelector('header.akwan_website_header').clientHeight;

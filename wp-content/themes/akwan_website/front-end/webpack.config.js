...
module.exports = function (env, argv) {
  ...
  return {
    ...
    output: {
      ...
      publicPath: argv.mode === 'production' || env.asBuild ? '/' + (env && env.subDomain || '') + 'wp-content/themes/akwan_website/assets/' : './',
    },
          ...
          use: [{
            ...
            options: {
              publicPath: function (url) {
                return argv.mode === 'production' || env.asBuild ? '/' + (env && env.subDomain || '') + 'wp-content/themes/akwan_website/assets/' + url : './' + url;
              },
              name: '[path][name].[ext]',

	...
	class acf_field_section_styles extends acf_field {
          ...
          <div class="acf-section-styles-container" tabindex="-1">
            ...
            <div class="acf-section-styles-box-model">
              <div class="acf-section-styles-margin acf-section-style-param">
                ...
                <input id="<?php echo $field['id']; ?>_margin" class="top" placeholder="&ndash;" name="<?php echo esc_attr( $field['name'] ) ?>[margin_top]" value="<?php if ( ! empty( $field['value']['margin_top'] ) ) {
					echo $field['value']['margin_top'];
				} ?>"/>
                <input class="right" placeholder="&ndash;" name="<?php echo esc_attr( $field['name'] ) ?>[margin_right]" value="<?php if ( ! empty( $field['value']['margin_top'] ) ) {
					echo $field['value']['margin_right'];
				} ?>"/>
                <input class="bottom" placeholder="&ndash;" name="<?php echo esc_attr( $field['name'] ) ?>[margin_bottom]" value="<?php if ( ! empty( $field['value']['margin_top'] ) ) {
					echo $field['value']['margin_bottom'];
				} ?>"/>
                <input class="left" placeholder="&ndash;" name="<?php echo esc_attr( $field['name'] ) ?>[margin_left]" value="<?php if ( ! empty( $field['value']['margin_top'] ) ) {
					echo $field['value']['margin_left'];
				} ?>"/>
                <!-- End Margin -->
                
                <div id="<?php echo $field['id']; ?>_border_container" class="acf-section-styles-border acf-section-style-param"<?php if ( ! empty( $field['value']['border_color'] ) ) {
					echo ' style="background-color: ' . $field['value']['border_color'] . '"';
				} ?>>
                  <!-- Border -->
                  <div class="acf-label">
                  ...
                  <input id="<?php echo $field['id']; ?>_border" class="top" placeholder="&ndash;" min="0" name="<?php echo esc_attr( $field['name'] ) ?>[border_top]" value="<?php if ( ! empty( $field['value']['border_top'] ) ) {
					  echo $field['value']['border_top'];
				  } ?>"/>
                  <input class="right" placeholder="&ndash;" min="0" name="<?php echo esc_attr( $field['name'] ) ?>[border_right]" value="<?php if ( ! empty( $field['value']['border_right'] ) ) {
					  echo $field['value']['border_right'];
				  } ?>"/>
                  <input class="bottom" placeholder="&ndash;" min="0" name="<?php echo esc_attr( $field['name'] ) ?>[border_bottom]" value="<?php if ( ! empty( $field['value']['border_bottom'] ) ) {
					  echo $field['value']['border_bottom'];
				  } ?>"/>
                  <input class="left" placeholder="&ndash;" min="0" name="<?php echo esc_attr( $field['name'] ) ?>[border_left]" value="<?php if ( ! empty( $field['value']['border_left'] ) ) {
					  echo $field['value']['border_left'];
				  } ?>"/>
                  <!-- End Border -->
                  
                  <div id="<?php echo $field['id']; ?>_padding_container" class="acf-section-styles-padding acf-section-style-param"<?php if ( ! empty( $field['value']['background_color'] ) ) {
					  echo ' style="background-color: ' . $field['value']['background_color'] . '"';
				  } ?>>
                    <!-- Padding -->
                    <div class="acf-label">
                    ...
                    <input id="<?php echo $field['id']; ?>_padding" class="top" placeholder="&ndash;" min="0" name="<?php echo esc_attr( $field['name'] ) ?>[padding_top]" value="<?php if ( ! empty( $field['value']['padding_top'] ) ) {
						echo $field['value']['padding_top'];
					} ?>"/>
                    <input class="right" placeholder="&ndash;" min="0" name="<?php echo esc_attr( $field['name'] ) ?>[padding_right]" value="<?php if ( ! empty( $field['value']['padding_right'] ) ) {
						echo $field['value']['padding_right'];
					} ?>"/>
                    <input class="bottom" placeholder="&ndash;" min="0" name="<?php echo esc_attr( $field['name'] ) ?>[padding_bottom]" value="<?php if ( ! empty( $field['value']['padding_bottom'] ) ) {
						echo $field['value']['padding_bottom'];
					} ?>"/>
                    <input class="left" placeholder="&ndash;" min="0" name="<?php echo esc_attr( $field['name'] ) ?>[padding_left]" value="<?php if ( ! empty( $field['value']['padding_left'] ) ) {
						echo $field['value']['padding_left'];
					} ?>"/>
                    <!-- End Padding -->
            ...
            <div class="acf-section-styles-options">
              ...
              <div class="acf-section-styles-input-row">
                  ...
                  <div class="acf-section-styles-border-style-container">
                    ...
                    <select id="<?php echo $field['id']; ?>_border_style" name="<?php echo esc_attr( $field['name'] ) ?>[border_style]">
						<?php foreach ( $this->border_options as $v => $label ): ?>
                          <option value="<?php echo $v; ?>"<?php if ( ! empty( $field['value']['border_style'] ) && $field['value']['border_style'] == $v ) {
							  echo ' selected';
                ...
                <div class="acf-section-styles-input-col-half">
                  ...
                  <div class="acf-section-styles-border-color-container">
                    ...
                    <input class="acf-section-styles-border-color" name="<?php echo esc_attr( $field['name'] ) ?>[border_color]" id="<?php echo $field['id']; ?>_border_color" type="text" value="<?php if ( ! empty( $field['value']['border_color'] ) ) {
						echo $field['value']['border_color'];
					} ?>"/>
                  </div>
                  <!-- End Border Color -->
                </div>
              ...
              <div class="acf-section-styles-background-color-container">
                ...
                <input class="acf-section-styles-background-color" name="<?php echo esc_attr( $field['name'] ) ?>[background_color]" id="<?php echo $field['id']; ?>_background_color" type="text" value="<?php if ( ! empty( $field['value']['background_color'] ) ) {
					echo $field['value']['background_color'];
				} ?>"/>
              </div>
              ...
              <div <?php acf_esc_attr_e( $div ); ?>>
                ...
                <input type="hidden" id="<?php echo $field['id']; ?>_background_image" name="<?php echo esc_attr( $field['name'] ) ?>[background_image]" value="<?php if ( ! empty( $field['value']['background_image'] ) ) {
					echo $field['value']['background_image'];
				} ?>" class="acf-section-styles-background-image-input"/>
                
                <div class="view show-if-value">
                  <div class="acf-section-styles-background-image-preview-container"<?php if ( ! empty( $field['value']['background_color'] ) ) {
					  echo ' style="background-color: ' . $field['value']['background_color'] . '"';
				  } ?>>
                  ...
                  <p style="margin: 5px 0 0;">
                    <a href="#" class="acf-section-styles-background-image-remove" data-target="<?php echo $field['id']; ?>"><?php _e( 'Remove selected image', 'acf-section_styles' ); ?></a>
                  </p>
                  ...
                  <div class="acf-section-styles-background-style-container">
                    ...
                    <select id="<?php echo $field['id']; ?>_background_style" name="<?php echo esc_attr( $field['name'] ) ?>[background_style]">
						<?php foreach ( $this->background_style_options as $v => $label ): ?>
                          <option value="<?php echo $v; ?>"<?php if ( ! empty( $field['value']['background_style'] ) && $field['value']['background_style'] == $v ) {
							  echo ' selected';
						  } ?>><?php echo $label; ?></option>
						<?php endforeach; ?>
                    </select>
                      ...
                      <div class="acf-section-styles-input-col-half">
                        <select id="<?php echo $field['id']; ?>_background_position_1" name="<?php echo esc_attr( $field['name'] ) ?>[background_position_1]">
							<?php foreach ( $this->background_position_options_1 as $v => $label ): ?>
                              <option value="<?php echo $v; ?>"<?php if ( ! empty( $field['value']['background_position_1'] ) && $field['value']['background_position_1'] == $v ) {
								  echo ' selected';
							  } ?>><?php echo $label; ?></option>
							<?php endforeach; ?>
                        </select>
                      ...
                      <div class="acf-section-styles-input-col-half">
                        <select id="<?php echo $field['id']; ?>_background_position_2" name="<?php echo esc_attr( $field['name'] ) ?>[background_position_2]" class="acf-section-styles-background-position-1">
							<?php foreach ( $this->background_position_options_2 as $v => $label ): ?>
                              <option value="<?php echo $v; ?>"<?php if ( ! empty( $field['value']['background_position_2'] ) && $field['value']['background_position_2'] == $v ) {
								  echo ' selected';
							  } ?>><?php echo $label; ?></option>
							<?php endforeach; ?>
                        </select>
                ...
                <div class="view hide-if-value">
                  <p style="margin: 0;"><?php _e( 'No image selected', 'acf-section_styles' ); ?>
                    <a data-target="<?php echo $field['id']; ?>" class="acf-button button acf-section-styles-background-image-select" href="#"><?php _e( 'Add Image', 'acf-section_styles' ); ?></a>
                  </p>
                </div>
		...
		*/
		...
		function update_value( $value, $post_id, $field ) {
			...
			$default_unit = apply_filters( 'acf_section_styles_default_unit', '' );
